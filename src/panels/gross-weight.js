...
export function renderGrossWeight(shipment, onSave) {
    ...
    function draw() {
        ...
        const grossMT = gross !== null ? gross / 1000 : null;
        const grossDisplay = grossMT !== null ? formatMT(grossMT) : '—';
        const isNegative = gross !== null && gross < 0;
        const warning = grossMT !== null && shipment.netWeightMT && grossMT < shipment.netWeightMT
        ...
        openPanel(`
            ...
            <div class="panel-body">
                <div class="sh-gw-net-banner">
                    ...
                    <div class="sh-gw-net-val">${formatMT(shipment.netWeightMT)}</div>
                </div>
                ...
                <div class="sh-gw-result">
                    ...
                    <div style="font-size:0.75rem;color:var(--gray-400);">Truck With − Truck Without (auto-converted to MT)</div>
                    ${warning}
            ...
            <div class="panel-footer">
                ...
                <div class="panel-footer__right">
                    <button class="btn btn--primary" id="gwSave" ${grossMT === null || isNegative ? 'disabled style="opacity:.5;pointer-events:none;"' : ''}>
        ...
        pc.querySelector('#gwSave')?.addEventListener('click', () => {
            ...
            const gMT = g / 1000;
            shipment.grossWeightMT = gMT;
            closePanel();
            showToast('Gross Weight Saved', `Gross weight ${formatMT(gMT)} recorded for ${shipment.id}.`, 'success');
            if (onSave) onSave();
        });
    }
